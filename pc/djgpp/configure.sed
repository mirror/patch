...
#	$Id: configure.sed,v 1.7 1997/06/17 17:26:37 eggert Exp $
...
$a\
config.h: $(srcdir)/config.hin pc/djgpp/config.sed; sed -f $(srcdir)/pc/djgpp/config.sed $(srcdir)/config.hin >$@\
